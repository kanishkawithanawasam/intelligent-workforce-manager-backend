 ...
 *
 * <p>The {@code RealTimeSchedule} contains a list of {@link SchedulesEngineShift} objects and a fitness
...
public class RealTimeSchedule{
     ...
     */
    private final List<SchedulesEngineShift> shifts = new ArrayList<>();
     ...
     *
     * @return a list of {@link SchedulesEngineShift} objects
     */
    public List<SchedulesEngineShift> getShifts() {
        return shifts;
    }
