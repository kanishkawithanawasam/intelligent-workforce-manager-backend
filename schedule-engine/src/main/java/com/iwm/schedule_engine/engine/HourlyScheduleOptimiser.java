...
import com.iwm.schedule_engine.configurations.HSOConfigs;
...
public class HourlyScheduleOptimiser{
     ...
     *
     * @param shiftDtos      the complete weekly schedule containing all shifts
     ...
     */
    public List<SchedEngShiftDTO> getOptimisedRealTimeSchedule() {
